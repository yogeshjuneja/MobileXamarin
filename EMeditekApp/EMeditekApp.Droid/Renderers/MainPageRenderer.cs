...
using EMeditekApp.Droid.Renderers;
using Xamarin.Forms;
using EMeditekApp.Wellogo.Tabbedpage;
using BottomNavigationBar;
using BottomNavigationBar.Listeners;
using Xamarin.Forms.Platform.Android;

[assembly: ExportRenderer(typeof(TabbedPage1), typeof(MainPageRenderer))]
namespace EMeditekApp.Droid.Renderers
{
   internal  class MainPageRenderer: VisualElementRenderer<TabbedPage1>, IOnTabClickListener
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<TabbedPage1> e)
        {
        ...
        private void InitializeElement(TabbedPage1 element)
        {
        ...
        private void ClearElement(TabbedPage1 element)
        {
            if (_currentPage != null)
            {
